export const homeObjOne = {
  ...
  description:
    "TAM stands for technology awareness month, where we conduct events on generating awareness amongst students about the latest practical technologies in the industry of engineering. We focus on bringing light to the topics that are usually hind-sighted by the students of engineering.",
...
export const homeObjFive = {
  ...
  description:
    "Quizze are conducted to bring out the competitive side in you. Go on, grab a friend or a fellow classmate to challenge the knowledge which you have gained over the years. The quizzes mention below have two rounds each.",
...
export const princi = {
  ...
  description:
    "Dr.P.Santosh Kumar Patra , Principal of St.Martin's Engineering College is holding " +
  ...
  desc:
    ...
    '"GOVERNOR AWARD (THRICE) " , "Rastriya Gaurav Award" , "Rastriya Vikas Ratan Award , "Dronacharya' +
    'Award " , Young leader of the year 2019 & IBAE International Award, Dubai.',
  buttonLabel: "Contact Us",
  imgStart: true,
